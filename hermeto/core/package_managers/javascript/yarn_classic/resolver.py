...
from hermeto.core.package_managers.javascript.npm import YARN_REGISTRY_URL, is_from_npm_registry
from hermeto.core.package_managers.javascript.yarn_classic.project import (
    PackageJson,
    Project,
    YarnLock,
)
